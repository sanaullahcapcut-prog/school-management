...
export function DebitManagement({ 
  ...
  const exportToPDF = () => {
    const reportData = {
      title: "Debit Report",
      dateRange: `All debit transactions${dateRange.from && dateRange.to ? 
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage all debit transactions and expenses
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            A list of all debit transactions
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
      ...
      <Dialog open={!!editingTransaction} onOpenChange={() => setEditingTransaction(null)}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Update the debit transaction details
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="space-y-2">
